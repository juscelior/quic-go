...
func TestPragueSenderExitSlowStartOnECNMarks(t *testing.T) {
	...
	// Verify tracer received ECN feedback and alpha update
	require.NotEmpty(t, sender.tracer.ecnFeedbackEvents)
	require.NotEmpty(t, sender.tracer.pragueAlphaUpdates)
}
